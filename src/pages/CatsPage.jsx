...
function CatsPage() {
  ...
  >
        ...
        {/* ========== Card 07-B ========== */}
        <div className="flex justify-between items-baseline px-8">
          <div className="card bg-white bg-white rounded-md lg:card-side bg-base-100 shadow-xl w-[12rem] border border-cyan-400 border-x-2 border-y-2 transition hover:scale-110 hover:shadow-cyan-200">
            <figure>
          ...
          {/* ========== Card 08-B ========== */}
          <div className="card bg-white bg-white rounded-md lg:card-side bg-base-100 shadow-xl w-[12rem] border border-pink-400 border-x-2 border-y-2 transition hover:scale-110 hover:shadow-pink-200">
            <figure>
